...
param containerAppEnvironmentName = readEnvironmentVariable('AZURE_CONTAINER_APPS_ENVIRONMENT_NAME', '')
...
param typeSafeApiKeySecretUrl = readEnvironmentVariable('TYPESAFE_API_KEY_VAULT_URL', '')
