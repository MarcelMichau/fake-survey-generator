...
const SurveyResult = ({ surveyDetail }: SurveyResultProps) => {
	return (
		<div className="max-w-sm w-full lg:max-w-full lg:flex my-5">
			<div className="dark:bg-gray-900 border dark:border-gray-600 bg-white rounded-sm p-4 flex flex-col justify-between leading-normal shadow-md">
				<div className="mb-6">
									...
									<span>
										...
										<span
											className={`inline-block ${
												index === 0 ? "bg-green-200" : "bg-yellow-200"
